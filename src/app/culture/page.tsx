export default function Culture() {
  return (
    <>
      ...
      <section className="px-6 md:px-12 md:px-8 md:px-24 py-20 md:py-32 bg-surface-container-low">
        <div className="grid grid-cols-12 gap-8">
          {/* Pillar 1: Iron Discipline */}
          <div className="col-span-12 md:col-span-7 bg-surface-container-highest p-6 md:p-12 flex flex-col justify-between group relative overflow-hidden">
            <div className="absolute top-0 left-0 w-1 h-full bg-primary-container"></div>
            <div>
              <div className="flex justify-between items-start mb-12">
                <span className="font-headline font-black text-4xl md:text-6xl text-white/10 italic">
                  01
                </span>
            ...
            <img
              alt="Training"
              className="absolute right-0 bottom-0 w-1/3 h-2/3 object-cover grayscale opacity-20 group-hover:opacity-40 transition-opacity"
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuATHBQ7Lc0mFhnQ4hw1ytQpW_5PabNExgoTWIRoTIbrAyexQazdIjrEK3_ePMl27rcPgosi291bwIxMrDDp6dbdEd1Sbv4hguX73Q0acdxP1CZEuy7n79pScRq696Wp2kc4oL47GNSBesdYz-iD2Cz8X7dwcSKKQ2sd63DwrAv0CIDbqXdaWNJH2W6fif_l7mKWWXbewrXVHkcpoonEj0Mk0ZbRk6HTGxtocrSFiQxhrSbeoWhs6HuEkrXWrYPVPQXGC4m8KTP8qzC_"
            />
          </div>

          {/* Pillar 2: Elite Execution */}
          <div className="col-span-12 md:col-span-5 bg-surface-container-high p-6 md:p-12 flex flex-col justify-between border-l border-white/5">
            <div>
              <div className="flex justify-between items-start mb-12">
                <span className="font-headline font-black text-4xl md:text-6xl text-white/10 italic">
                  02
            ...
            <div className="mt-12 bg-surface-container-lowest p-6 border-l-2 border-primary-container">
              ...
              <div className="font-headline font-black text-3xl md:text-5xl text-on-surface">
                99.8%
              </div>
            </div>
          </div>
          ...
          <div
            className="col-span-12 p-6 md:p-12 md:p-10 md:p-20 flex flex-col md:flex-row justify-between items-center gap-6 md:p-12"
            style={{
              background: "linear-gradient(135deg, #e60000 0%, #690000 100%)",
            }}
          >
            <div className="max-w-2xl">
              <div className="flex items-center gap-4 mb-8">
                <span className="font-headline font-black text-4xl md:text-6xl text-white/20 italic">
                  03
                </span>
                <h3 className="font-headline font-extrabold text-3xl md:text-5xl uppercase tracking-tighter text-white">
              ...
              <ul className="space-y-6">
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <span className="text-white/80 font-body text-sm">
                      Absolute executive presence. Image is the first message of
                      competence.
                    </span>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <span className="text-white/80 font-body text-sm">
                      Total mental clarity. Zero tolerance for any substance
                ...
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <span className="text-white/80 font-body text-sm">
                      Leadership in every interaction. We communicate authority
                      and precision.
                    </span>
                  </div>
                </li>
            ...
            <div className="relative w-full md:w-1/3 aspect-square overflow-hidden border-8 border-white/10">
              <img
                ...
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuBwnOpbH38tqVksi6-s32k_VbQH1Ud6Wir9pWZrG1E2UzPRjNq7yqjgTAK3ldOHA7gEcyI6R1WedzlHYTToinLZlgyBo014yOelYQbGOqdztvalLGjtGTPdo4DQQ_dggDou5Q9yuL-lLhPMSYET24zqcZ_D11xrCkNBxfjBY4-6JYX_WXx-Rk17fjDLxufuSEhNSA362TKerwf0JmP2-KyrHRwwktIPm_tF9U81FE-n4aUrmINaEWYYxvXcjHDkLCGjgzw_oIV_vN6-"
              />
            </div>
          </div>
        </div>
      ...
      <section className="py-20 md:py-32 px-6 md:px-12 md:px-8 md:px-24 flex flex-col items-center text-center">
        <h2 className="font-headline font-black text-4xl md:text-6xl lg:text-7xl lg:text-8xl uppercase tracking-tighter mb-24 opacity-20">
          The Command Center
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-1 w-full max-w-7xl bg-white/5 p-1">
          <div className="bg-surface-dim p-6 md:p-12">
            <div className="font-headline font-black text-4xl md:text-6xl text-primary-container mb-2">
              04
            </div>
      ...
      <section className="relative py-24 md:py-40 px-6 md:px-12 overflow-hidden bg-surface-container-lowest">
        ...
        <div className="relative z-10 text-center max-w-3xl mx-auto">
          <h2 className="font-headline font-extrabold text-4xl md:text-6xl uppercase tracking-tighter mb-8">
            Do You Have the Discipline?
          </h2>
          <p className="font-body text-on-surface-variant text-lg mb-12">
            We seek the 1%. Those who find freedom in rules and power in
            structure. If you seek comfort, this is not your place.
          </p>
          <div className="flex justify-center flex-col sm:flex-row gap-4">
            <button className="bg-primary-container text-on-primary-container font-headline font-bold uppercase tracking-tight px-6 md:px-12 py-6 transition-all hover:bg-surface-bright">
              Apply to Vanguard
            </button>
          </div>
        </div>
